...
public class CommonRefreshFooter extends FrameLayout implements PtrUIHandler {
    ...
    public CommonRefreshFooter(Context context, AttributeSet attrs, int defStyleAttr) {
