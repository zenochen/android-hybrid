...
public class SharedPref {
    ...
    public static final String DEVICE_TOKEN = "deviceToken";//友盟获取的设备号
    public static final String USER_TOKEN = "token";//用户token
    public static final String LOCATION = "location";//位置信息
    public static final String APP_AD_LOCAL = "appAdLocal";//广告页本地图片
    public static final String HOME_IMAGES_LOCAL = "homeImagesLocal";//首页轮播图本地
    public static final String USER_IMAGE_LOCAL = "userImagesLocal";//个人页图片本地
}
